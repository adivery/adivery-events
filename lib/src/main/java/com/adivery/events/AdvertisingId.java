...
public class AdvertisingId {
    ...
    private static final String ADVERTISING_ID_SERVICE_NAME =
    ...
    private void fetchAdvertisingId(Context context) {
        ...
        try {
            ...
            Logger.error("Couldn't bind to identifier service intent", e);
        }
        try {
            if (didBind) {
            ...
            Logger.error("Couldn't get advertising info", e);
        } finally {
            if (didBind) {
    ...
    private interface GoogleAdvertisingInfo extends IInterface {
        ...
        abstract class GoogleAdvertisingInfoBinder extends Binder implements GoogleAdvertisingInfo {
            ...
            public static GoogleAdvertisingInfo create(IBinder binder) {
                ...
                if (localIInterface instanceof GoogleAdvertisingInfo) {
    ...
    private static class GoogleAdvertisingServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            try {
                ...
                Logger.debug("Couldn't put service to binder que");
            }
        }
